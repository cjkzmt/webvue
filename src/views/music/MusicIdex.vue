...
import { ref } from 'vue'
import DlgPCCreateOrEdit from './DlgMusicCreateOrEdit.vue'
queryMusic()
...
<template>
  <el-card style="max-width: auto">
    ...
    <el-table :data="queriedResult.records" border style="width: 100%">
      ...
      <el-table-column prop="name" label="音乐名"  align="center" />
      <el-table-column prop="duration" label="时长（秒）" align="center" />
      <el-table-column prop="url" label="音乐链接" align="center" />
      <el-table-column
        prop="createdTime"
        label="录入时间"
        width="180"
