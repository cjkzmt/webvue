...
<template>
  <el-card style="max-width: auto">
    <template #header>
      ...
      >
        <el-form :inline="true" :model="queryCondition" class="demo-form-inline">
          <!-- <el-form-item label="配音品牌">
            <el-input v-model="queryCondition.Brand" placeholder="请输入配音品牌" clearable />
          </el-form-item> -->
          ...
          <el-form-item>
            <el-button type="primary" @click="queryVoiceOver({ currentPage: 1 })">查询</el-button>
          </el-form-item>
        </el-form>
        <el-button
          class="Createbutton"
    ...
    <el-table :data="queriedResult.records" border style="width: 100%">
      ...
      <el-table-column prop="name" label="配音名" align="center" />
      <el-table-column prop="filename" label="文件名" width="800" align="center" />
      <el-table-column prop="sex" label="性别" width="180" align="center" />
      <el-table-column prop="url" label="配音链接" align="center" />
      <el-table-column
        prop="createdTime"
        label="录入时间"
        width="180"
    ...
    <el-pagination
      ...
      @size-change="(pageSize: number) => queryVoiceOver({ pageSize, currentPage: 1 })"
      @current-change="(currentPage: number) => queryVoiceOver({ currentPage })"
    />
