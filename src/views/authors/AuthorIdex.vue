...
<template>
  <el-card style="max-width: auto">
    <template #header>
      ...
      >
        <el-form :inline="true" :model="queryCondition" class="demo-form-inline">
          ...
          <el-form-item>
            <el-button type="primary" @click="queryAuthor({ currentPage: 1 })">查询</el-button>
          </el-form-item>
        </el-form>
        <el-button
          class="Createbutton"
    ...
    <el-table :data="queriedResult.records" border style="width: 100%">
      ...
      <el-table-column prop="name" label="作者名" width="180" align="center" />
      <el-table-column prop="number" label="作者号" width="180" align="center" />
      <el-table-column prop="url" label="链接" width="180" align="center" />
      <el-table-column prop="urlnum" label="作品数" width="180" align="center" />
    ...
    <el-pagination
      ...
      @size-change="(pageSize: number) => queryAuthor({ pageSize, currentPage: 1 })"
      @current-change="(currentPage: number) => queryAuthor({ currentPage })"
    />
    <DlgAuthorCreateOrEdit ref="dlgCreateOrEdit" />
  </el-card>
</template>
