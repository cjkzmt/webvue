...
import { queriedResult, queryCondition, queryPromptText, handleDelete, handleStatusChange } from '@/composables/usePromptText'
import { timeFormatter } from '@/utils/timeHandler'
import { ref} from 'vue'
import DlgPCCreateOrEdit from './DlgPromptTextCreateOrEdit.vue'
queryPromptText()
...
<template>
  <el-card style="max-width: auto">
    <template #header>
      ...
      >
        <el-form :inline="true" :model="queryCondition" class="demo-form-inline">
          <!-- <el-form-item label="提示词品牌">
            <el-input v-model="queryCondition.Brand" placeholder="请输入提示词品牌" clearable />
          </el-form-item> -->
          ...
          <el-form-item>
            <el-button type="primary" @click="queryPromptText({ currentPage: 1 })">查询</el-button>
          </el-form-item>
        </el-form>
        <el-button
          class="Createbutton"
    ...
    <el-table :data="queriedResult.records" border style="width: 100%">
      ...
      <el-table-column prop="text" label="提示词名" width="1000" align="center" />
      <el-table-column
        prop="createdTime"
        label="注册时间"
        width="180"
    ...
    <el-pagination
      ...
      @size-change="(pageSize: number) => queryPromptText({ pageSize, currentPage: 1 })"
      @current-change="(currentPage: number) => queryPromptText({ currentPage })"
    />
